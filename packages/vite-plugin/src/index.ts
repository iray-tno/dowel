...
/// understood.
const DOWEL_PRIMITIVES = ['View', 'Text', 'Paragraph', 'Heading', 'Section', 'Article', 'Nav', 'List', 'ListItem', 'Pressable', 'Button', 'Link', 'TextInput', 'Dialog', 'Image', 'ScrollView', 'FlatList', 'PanResponder'] as const
